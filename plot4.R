##
## This file contains the functions to plot graph 4 in project 1 for 
...
## Function to plot graph 4

plot4 <- function(inputFile = "household_power_consumption.txt",
                  nSkip = NumSkip, 
    ...
    # plot sub-graph for Global Active Power vs time
    plot(dat$DateTime,
    ...
    # Plot sub-graph for Voltage vs time 
    plot(dat$DateTime,
         dat$Voltage, 
         type = "l",
         xlab = "datetime",
    ...
    # Plot sub-graph for sub metering 1, 2, 3 vs time
    plot(dat$DateTime,
         dat$Sub_metering_1, 
         type = "l",
         col = "black",
    ...
    # plot sub-graph for Global Reactive Power vs time
    plot(dat$DateTime,
